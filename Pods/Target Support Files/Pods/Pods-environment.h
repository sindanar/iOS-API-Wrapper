...
// isFull
#define COCOAPODS_POD_AVAILABLE_isFull
#define COCOAPODS_VERSION_MAJOR_isFull 0
#define COCOAPODS_VERSION_MINOR_isFull 0
#define COCOAPODS_VERSION_PATCH_isFull 2
